...
```bash
bash .github/skills/filter-tells/scripts/detect-lexical.sh <file-or-dir> [file-or-dir ...]
```
...
```bash
python3 .github/skills/filter-tells/scripts/detect-structural.py <file-or-dir> [file-or-dir ...]
```
...
```bash
python3 .github/skills/match-structure/scripts/style.py --db <db> corpus   # writes voice-profile.json
python3 .github/skills/filter-tells/scripts/detect-structural.py <files> --voice-profile=<db-dir>/voice-profile.json
```
...
```bash
python3 .github/skills/filter-tells/scripts/voice_anchors.py discover <file>
```
...
```bash
python3 .github/skills/filter-tells/scripts/voice_anchors.py profile --for <file>
python3 .github/skills/filter-tells/scripts/detect-structural.py <file> \
...
```bash
python3 .github/skills/filter-tells/scripts/voice_anchors.py anchors --text <passage-file>|- --for <file> -k 3
```
