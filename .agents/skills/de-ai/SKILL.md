...
```bash
python3 .agents/skills/de-ai/scripts/voice_anchors.py discover <file>
```
...
```bash
python3 .agents/skills/de-ai/scripts/voice_anchors.py profile --for <file>
python3 .agents/skills/de-ai/scripts/detect-structural.py <file> \
...
```bash
python3 .agents/skills/de-ai/scripts/voice_anchors.py anchors --text <passage-file>|- --for <file> -k 3
```
...
```bash
python3 .agents/skills/de-ai/scripts/md_paragraphs.py <file.md> [--json] [--coverage-only]
```
