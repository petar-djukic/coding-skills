...
```bash
bash .agents/skills/filter-tells/scripts/detect-lexical.sh <file-or-dir> [file-or-dir ...]
```
...
```bash
python3 .agents/skills/filter-tells/scripts/detect-structural.py <file-or-dir> [file-or-dir ...]
```
...
```bash
python3 .agents/skills/match-structure/scripts/style.py --db <db> corpus   # writes voice-profile.json
python3 .agents/skills/filter-tells/scripts/detect-structural.py <files> --voice-profile=<db-dir>/voice-profile.json
```
...
```bash
python3 .agents/skills/filter-tells/scripts/voice_anchors.py discover <file>
```
...
```bash
python3 .agents/skills/filter-tells/scripts/voice_anchors.py profile --for <file>
python3 .agents/skills/filter-tells/scripts/detect-structural.py <file> \
...
```bash
python3 .agents/skills/filter-tells/scripts/voice_anchors.py anchors --text <passage-file>|- --for <file> -k 3
```
...
```bash
python3 .agents/skills/filter-tells/scripts/md_paragraphs.py <file.md> [--json] [--coverage-only]
```
...
1. Mechanical checks:
   ```bash
   python3 .agents/skills/filter-tells/scripts/abstract-check.py <paper.md> \
...
```bash
bash .agents/skills/filter-tells/scripts/detect-lexical.sh <file-or-dir>
python3 .agents/skills/filter-tells/scripts/detect-structural.py <file-or-dir> --json
```
